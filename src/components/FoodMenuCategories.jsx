...
const FoodMenuCategories = () => {
  ...
  return (
    <Row className="custom-margin-top gap-4 px-3 px-lg-2">
      <Col className="categories-box card-custom" onClick={() => scrollToAnchor('pizzasMenu')}>
      ...
      <Col className="categories-box card-custom" onClick={() => scrollToAnchor('sideDishesMenu')}>
      ...
      <Col className="categories-box card-custom" onClick={() => scrollToAnchor('beveragesMenu')}>

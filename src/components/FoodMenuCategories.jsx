...
const FoodMenuCategories = () => {
  ...
  return (
    <Row className="custom-margin-top gap-4">
      <Col className="mx-sm-4 position-relative overflow-visible d-flex flex-column justify-content-center align-items-center card-custom rounded-4 text-uppercase py-4">
        <a href="#pizzasMenu" className="text-white">
          <Image src="https://as1.ftcdn.net/v2/jpg/01/44/16/30/1000_F_144163074_2GIzTmGuL3gAJZEtvWXxMdOk7FiasIIl.jpg"
            width={160} className="border border-2 border-white rounded-3 position-absolute top-0 start-50 translate-middle" />
          <div className="fs-4 mx-4 pt-4">
            Pizzas <span className="text-emphasis">Artesanales</span>
          </div>
        </a>
      </Col>
      <Col className="mt-sm-4 position-relative overflow-visible d-flex flex-column justify-content-center align-items-center card-custom rounded-4 text-uppercase py-4">
      ...
      <Col className="mt-sm-4 position-relative overflow-visible d-flex flex-column justify-content-center align-items-center card-custom text-white rounded-4 text-uppercase py-4">

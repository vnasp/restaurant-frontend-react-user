...
const ConfirmationPage = () => {
  ...
  return (
    <Container>
      ...
      <Row className="flex-column flex-lg-row card-custom custom-shadow custom-margin-bottom p-2 p-lg-0 mx-1">
        ...
        <Col className="col-12 col-lg-4 confirmation-custom-background">
        </Col>
      </Row>
    </Container>
  )

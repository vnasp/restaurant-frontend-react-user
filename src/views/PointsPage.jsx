    ...
    <Container>
      <div className="card-custom custom-margin-bottom text-white">
        <div className="px-4 mx-4">
          ...
          <h3 className="text-center pt-4">¡Sé parte! Degusta más, ahorra más.</h3>
          <div className="fs-4 py-4">En pizzería Mamma Mia, queremos agradecer a nuestros clientes su lealtad. Por cada compra, acumula MammaPuntos que puedes canjear por deliciosas recompensas.
          </div>
          ...
          <div className="mb-4 fs-4 text-center">
            ¿Listo para unirte?<br/>
            ¡Haz más con cada bocado! Inscríbete y comienza a acumular MammaPuntos hoy.<br /><br/>
              <a onClick={handleInscribeClick} className="btn secondary fs-4 inactive">
